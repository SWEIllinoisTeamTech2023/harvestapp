  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <input className='inputBox' type="number" value={yieldValue} onChange={handleYieldChange} min="0" placeholder='Yield (lbs)' />
        </div>
        <div>
          <input className='inputBox' type="number" value={headerWidthValue} onChange={handleHeaderWidthChange} min="0" placeholder='Header Width (unit)' />
        </div>
        <div>
          <input className='inputBox' type="number" value={tradeCostValue} onChange={handleTradeCostChange} min="0" placeholder='Trade Cost ($)' />
        </div>
        <button className='button' type="submit" style={{ marginTop: '50px', height: '70px' }} >Calculate Cost of Harvest</button>
      </form>
    </div>
  );
};
